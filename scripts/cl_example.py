...
This example plots a list of Gaussian distribution
Usage example:

python3 cl_example.py -m 0 5 10 15 20 -s 1 1 1 7 2 -n 5000 5000 5000 10000 5000
--names "x1" "x2" "x3" "x4" "x5" -b 100 --normalize
"""
...
def generate_distributions(means, stds, n_samples):
    """
    Generates a list of Gaussian distributions:
    :param means: list of mean values of the N distributions
    :param stds: list of std values of the N distributions
    :param n_samples: list of number of samples of the N distributions
    :return: list of random variables (each distribution a saparate numpy array)
    """
...
def visualize_distributions(data, dist_names, norm=False, n_bins=10):
    """
    Visualize histograms of a list of distributions
    :param data: list of Gaussian distriburtions as generated by
                 generate_distributions()
    :param dist_names: distribution name
    :param norm: normalize histograms
    :param n_bins: number of bins to be used in each histogram
    """
